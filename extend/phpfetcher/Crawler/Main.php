...
abstract class Main extends \phpfetcher\Crawler\Api {
    ...
    const DEFAULT_PAGE_CLASS = '\\phpfetcher\\Page\\Main';
    const ABSTRACT_PAGE_CLASS = '\\phpfetcher\\Page\\Api';
    ...
    public function getFetchJobByName($job_name) {
        return $this->_arrFetchJobs[$job_name];
    }
    ...
    public function &run($arrInput = array()) {
        ...
        try {
            ...
            if (!($objPage instanceof \phpfetcher\Page\Api)) {
